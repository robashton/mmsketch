...
set shortmess=aoO
badd +0 site/index.html
badd +0 site/feedbacktabs.js
badd +0 test/feedbacktabs.coffee
badd +0 test/authentication.coffee
badd +0 test/context.coffee
silent! argdel *
edit test/context.coffee
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ \ $*\ test/context.coffee
setlocal matchpairs=(:),{:},[:]
setlocal nomodeline
setlocal modifiable
...
silent! normal! zE
let s:l = 159 - ((0 * winheight(0) + 21) / 43)
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ \ $*\ test/feedbacktabs.coffee
setlocal matchpairs=(:),{:},[:]
setlocal nomodeline
setlocal modifiable
setlocal nrformats=octal,hex
...
wincmd w
argglobal
edit test/authentication.coffee
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ \ $*\ test/authentication.coffee
setlocal matchpairs=(:),{:},[:]
setlocal nomodeline
setlocal modifiable
setlocal nrformats=octal,hex
